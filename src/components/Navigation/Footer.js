...
function Footer() {
  ...
  return (
    <Nav p="lg" position="fixed" width="100%" zIndex="1000" bottom="0" show="sm" boxShadow="reg" justifyContent="space-around">
        <NavItem to={{ pathname: "/timer", state: slideUp }} borderRadius="circle" backgroundColor="bg.1" p="md" mr="md" width="40px" height="40px" textAlign="center" fontSize="1.5em" overflow="hidden">
          <Icon icon="clock" style={{ verticalAlign: '25%' }} />
        </NavItem>
        <Container>
          <NavItem to={{ pathname: "/progression", state: slideUp }} borderRadius="circle" backgroundColor="bg.1" p="md" ml="md" width="40px" height="40px" textAlign="center" fontSize="1.5em">
